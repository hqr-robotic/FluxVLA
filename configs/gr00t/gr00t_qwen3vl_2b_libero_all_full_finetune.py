...
# GR00T VLA: Qwen3-VL-2B (native hidden_size=2048) + FlowMatchingHead.
# VLM backbone dim (2048) matches diffusion cross_attention_dim, no projection.
    ...
    dataset=dict(
        ...
        datasets=dict(
            ...
            data_root_path=[  # noqa: E251
                'datasets/libero_10_no_noops_lerobot',
                'datasets/libero_goal_no_noops_lerobot',
                'datasets/libero_spatial_no_noops_lerobot',
                'datasets/libero_object_no_noops_lerobot',
            ],
            transforms=[
                dict(
