...
# Example whole-body (loco-manipulation) config for the Oli humanoid.
# 1 head camera, 33-dim state, 42-dim action. Model dims (state_dim,
# action_dim, ori_action_dim) are example values; align them with the
# trained checkpoint.
        ...
        datasets=[
            dict(
                ...
                data_root_path=[  # noqa: E501
                    './datasets/RealRobot_Oli_lerobot/oli_example',  # noqa: E501
                ],
                transforms=[
                    dict(
