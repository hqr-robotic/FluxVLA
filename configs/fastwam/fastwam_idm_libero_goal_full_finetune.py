...
#
# FastWAM world-action model (idm, teacher-forcing) on LIBERO-goal.
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=dict(
            ...
            '/root/projects/ryanhu/data/libero_mujoco3.3.2/libero_goal_no_noops_lerobot',  # noqa: E501
            transforms=[
                dict(
...
eval = dict(
    runner=dict(
        ...
        norm_stats_key='libero_goal_no_noops',
        eval_chunk_size=10,
    ...
    manager=dict(
        output_dir=('/root/projects/ryanhu/FluxVLA/FastWAM/evaluate_results/'
                    'libero/fastwam_idm_libero_goal_full_finetune'),
        num_gpus=8,
        max_tasks_per_gpu=2,
