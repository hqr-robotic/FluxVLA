...
#
# FastWAM world-action model (idm, teacher-forcing) on LIBERO-10.
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=dict(
            ...
            '/root/projects/ryanhu/data/libero_mujoco3.3.2/libero_10_no_noops_lerobot',  # noqa: E501
            transforms=[
                dict(
...
eval = dict(
    ...
    manager=dict(
        output_dir=('/root/projects/ryanhu/FluxVLA/FastWAM/evaluate_results/'
                    'libero/fastwam_idm_libero_10_full_finetune'),
        num_gpus=8,
        max_tasks_per_gpu=2,
